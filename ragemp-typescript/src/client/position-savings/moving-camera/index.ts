...
mp.events.add(CAMERA_EVENTS.GET_CAM_COORDS, (name) => {
    mp.events.callRemote(CAMERA_EVENTS.SAVE_CAM_COORDS, JSON.stringify(coords), JSON.stringify(pointingAt(fly.point_distance)), name);
});
